About openinference-instrumentation-langchain-feedstock
=======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openinference-instrumentation-langchain-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openinference-instrumentation-langchain-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openinference-instrumentation-langchain
# for installing globally
pixi global install openinference-instrumentation-langchain
```
...
It is possible to list all of the versions of `openinference-instrumentation-langchain` available on your platform:
...
```
pixi search openinference-instrumentation-langchain --channel conda-forge
```
